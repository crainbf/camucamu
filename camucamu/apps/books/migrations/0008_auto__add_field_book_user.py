...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing M2M table for field user on 'Book'
        db.delete_table('books_book_user')
    ...
    def backwards(self, orm):
        ...
        # Adding M2M table for field user on 'Book'
        db.create_table('books_book_user', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('book', models.ForeignKey(orm['books.book'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('books_book_user', ['book_id', 'user_id'])
